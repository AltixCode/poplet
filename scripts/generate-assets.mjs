#!/usr/bin/env node
/**
 * Generates every brand asset for Poplet from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"circle","cx":0.3,"cy":0.27,"r":0.2,"fill":"accentMid"},{"type":"circle","cx":0.7,"cy":0.27,"r":0.2,"fill":"accent"},{"type":"circle","cx":0.5,"cy":0.58,"r":0.2,"fill":"accentLight"},{"type":"circle","cx":0.5,"cy":0.9,"r":0.105,"fill":"accent"}];
 ...
 */
const MARK = [[0.12,1,1,1,0.12],[1,1,0.45,1,1],[1,0.45,0.45,0.45,1],[0.45,1,0.45,1,0.45],[0.12,0.45,1,0.45,0.12]];
...
console.log('Generating Poplet brand assets\n');
