...
/**
 * Store identity and native configuration for Poplet.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Poplet works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.poplet',
    buildNumber: BUILD,
    supportsTablet: true,
