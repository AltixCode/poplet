...
poplet was built and uploaded to TestFlight on 2026-09-15 **without ever having
...
Poplet is a 120-level shooting puzzle. Every level is proven by solver to have exactly one solution.
...
| | State | Id |
|---|---|---|
| Bundle id registered | ✅ | `com.altixcode.poplet` |
| App Store Connect record | ✅ | 6812275902 |
...
| iOS IAP created and priced | ✅ | 6812277235 |
