...
**Poplet** — aim, shoot, pop three or more of a colour.
Plan: `/Volumes/ExtremePro/Dev/next_mobile_apps/PLAN_2.md` (PLAN_2.md §3).
...
1. **Write the game.** Nothing of it exists yet — hex grid, aim/bounce, cluster pop and orphan drop.
   The plan for this app is `next_mobile_apps/PLAN_2.md` (PLAN_2.md §3).
...
3. **Free tier**, as planned: levels 1-40.
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.poplet` |
| Scheme | `poplet://` |
| GitHub | `AltixCode/poplet` |
| RevenueCat project | `proj0bef76ad` |
| RevenueCat iOS app | `app53c812c3ff` |
| RevenueCat Android app | `app606a73cadf` |
| Entitlement | `remove_ads` (`entlbbf5a6bc49`) |
| Offering / package | `default` (`ofrng8bc1ffa47b`) / `$rc_lifetime` (`pkgec7bb12b329`) |
| AdMob app (iOS) | `ca-app-pub-2504845459806550~2684993727` |
| AdMob app (Android) | `ca-app-pub-2504845459806550~5688852006` |
| AdMob banner (iOS / Android) | `ca-app-pub-2504845459806550/3199999046` / `ca-app-pub-2504845459806550/7128082879` |
| AdMob interstitial (iOS / Android) | `ca-app-pub-2504845459806550/1007370965` / `ca-app-pub-2504845459806550/3348619966` |
| AdMob rewarded (iOS / Android) | `ca-app-pub-2504845459806550/7985421868` / `ca-app-pub-2504845459806550/7591117304` |
| App Store app id | `6812275902` |
| App Store name | Poplet Bubble Pop |
| IAP id / product | `6812277235` / `com.altixcode.poplet.removeads` |

All ten release identifiers plus `EXPO_TOKEN` are already GitHub repo secrets.
Locally they come from `/Volumes/ExtremePro/Dev/mobile_expo_apps/.admob-ids/poplet.env` —
...
1. **App Store Connect record — done.** App `6812275902` exists, with
   ...
   is **Poplet Bubble Pop**, which may differ from the in-app name: App
...
- Shared code is generated. Fix it in `AltixCode/next-mobile-apps` (`_template/`)
  and re-run `node scripts/bootstrap.mjs poplet`, never in this copy —
