...
const BENEFITS = ["Every level unlocked — 300+ hand-tuned boards","No ads, ever","Unlimited aim guides and undo","The daily challenge archive"];
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background, paddingTop: insets.top }}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.xl, paddingBottom: spacing['3xl'] }}>
        <Text variant="display">Poplet Pro</Text>
        <Text variant="body" tone="muted" style={{ marginTop: spacing.sm }}>
          Aim, shoot, pop. Fixed shots, one right answer.
        </Text>
